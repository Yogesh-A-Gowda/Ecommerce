...
const AnalyticsTab = () => {
    ...
    AnalyticsCard.propTypes = {
        ...
        value: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired, // The value can be either a string or a number and is required
        icon: PropTypes.elementType.isRequired, // The icon must be a React component and is required
        color: PropTypes.string.isRequired, // The color must be a string and is required
    };
